...
export class MockStub {
   ...
   * @param {string} method
   * @param {string} path
   * @returns {{return: (status: number, body?: any, throttle?: number) => MockStubOne}}
   */
  when(method, path) {
    return {
      /**
...
class MockStubOne {
   ...
   * @param {string} method
   * @param {string} path
   * @returns {{return: (status: number, body?: any, throttle?: number) => MockStubMulti}}
   */
  when(method, path) {
    return {
      /**
