...
import { ConfirmAuthMfaCommand } from '../../../../../src/clients/api/commands/auth/confirm-auth-mfa-command.js';
import { CreateAuthMfaCommand } from '../../../../../src/clients/api/commands/auth/create-auth-mfa-command.js';
import { DeleteAuthMfaCommand } from '../../../../../src/clients/api/commands/auth/delete-auth-mfa-command.js';
import { GetAuthMfaBackupCodesCommand } from '../../../../../src/clients/api/commands/auth/get-auth-mfa-backup-codes-command.js';
import { UpdateAuthPasswordCommand } from '../../../../../src/clients/api/commands/auth/update-auth-password-command.js';
...
describe.skip('auth commands', function () {
  ...
  it.only('should delete auth mfa', async () => {
