...
import { CreateAddonProviderFeatureCommand } from '../../../../../src/clients/api/commands/addon-provider/create-addon-provider-feature-command.js';
import { CreateAddonProviderPlanCommand } from '../../../../../src/clients/api/commands/addon-provider/create-addon-provider-plan-command.js';
import { DeleteAddonProviderCommand } from '../../../../../src/clients/api/commands/addon-provider/delete-addon-provider-command.js';
import { DeleteAddonProviderFeatureCommand } from '../../../../../src/clients/api/commands/addon-provider/delete-addon-provider-feature-command.js';
import { DeleteAddonProviderPlanCommand } from '../../../../../src/clients/api/commands/addon-provider/delete-addon-provider-plan-command.js';
import { GetAddonProviderCommand } from '../../../../../src/clients/api/commands/addon-provider/get-addon-provider-command.js';
import { ListAddonProviderFeatureCommand } from '../../../../../src/clients/api/commands/addon-provider/list-addon-provider-feature-command.js';
import { ListAddonProviderPlanCommand } from '../../../../../src/clients/api/commands/addon-provider/list-addon-provider-plan-command.js';
import { UpdateAddonProviderCommand } from '../../../../../src/clients/api/commands/addon-provider/update-addon-provider-command.js';
import { UpdateAddonProviderPlanCommand } from '../../../../../src/clients/api/commands/addon-provider/update-addon-provider-plan-command.js';
...
describe('addon-provider commands', function () {
  this.timeout(10000);
