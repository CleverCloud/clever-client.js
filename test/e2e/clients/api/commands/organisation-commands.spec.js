...
import { AddOrganisationMemberCommand } from '../../../../../src/clients/api/commands/organisation/add-organisation-member-command.js';
...
import { ListOrganisationCommand } from '../../../../../src/clients/api/commands/organisation/list-organisation-command.js';
import { ListOrganisationMemberCommand } from '../../../../../src/clients/api/commands/organisation/list-organisation-member-command.js';
import { UpdateOrganisationAvatarCommand } from '../../../../../src/clients/api/commands/organisation/update-organisation-avatar-command.js';
import { UpdateOrganisationCommand } from '../../../../../src/clients/api/commands/organisation/update-organisation-command.js';
import { UpdateOrganisationMemberCommand } from '../../../../../src/clients/api/commands/organisation/update-organisation-member-command.js';
...
describe('organisation commands', function () {
  ...
  describe('members', () => {
    it('should list members', async () => {
      ...
      expect(response[0].preferredMFA).to.equal('TOTP');
