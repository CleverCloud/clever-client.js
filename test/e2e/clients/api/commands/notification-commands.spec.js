/**
 * @import { EmailNotificationTarget, WebhookNotificationUrl } from '../../../../../src/clients/api/commands/notification/notification.types.js'
 */
import { expect } from 'chai';
import { CreateEmailNotificationCommand } from '../../../../../src/clients/api/commands/notification/create-email-notification-command.js';
import { CreateWebhookNotificationCommand } from '../../../../../src/clients/api/commands/notification/create-webhook-notification-command.js';
import { DeleteEmailNotificationCommand } from '../../../../../src/clients/api/commands/notification/delete-email-notification-command.js';
import { DeleteWebhookNotificationCommand } from '../../../../../src/clients/api/commands/notification/delete-webhook-notification-command.js';
import { GetNotificationInfoCommand } from '../../../../../src/clients/api/commands/notification/get-notification-info-command.js';
import { ListEmailNotificationCommand } from '../../../../../src/clients/api/commands/notification/list-email-notification-command.js';
...
describe('notification commands', function () {
  ...
  it('should create email notification 2', async () => {
    /** @type {Array<EmailNotificationTarget>} */
    const targets = [
      {
        type: 'email',
