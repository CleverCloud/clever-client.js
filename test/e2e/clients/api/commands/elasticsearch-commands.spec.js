...
import { GetElasticsearchInfoCommand } from '../../../../../src/clients/api/commands/elasticsearch/get-elasticsearch-info-command.js';
import { e2eSupport } from '../../../../lib/e2e-support.js';

describe('elasticsearch commands', function () {
  this.timeout(10000);
