import { CleverHttpError } from './clever-client-errors.js';

/**
 * @typedef {import('../request/request.types.js').Response<?>} Response
 */
...
export function handleHttpErrors (response) {
  if (response.status >= 400) {
    ...
    throw new CleverHttpError(errorMessage, response);
