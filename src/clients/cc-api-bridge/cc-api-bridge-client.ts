...
import type { CcApiBridgeClientConfig, CcApiBridgeType } from './types/cc-api-bridge.types.js';
 ...
 */
export class CcApiBridgeClient extends CcClient<CcApiBridgeType> {
  /**
   ...
   *
   * @param config - Client configuration including OAuth tokens
   */
