...
/**
 * Describes the new state of the organisation. A company is identified by its legal name and its
 * VAT number, any other organisation by the country it is based in.
 */
export type UpdateOrganisationCommandInput = UpdateOrganisationStandard | UpdateOrganisationCompany;

/**
 * The organisation as it stands after the update.
 */
...
interface UpdateOrganisationBase {
  /** Identifier of the organisation to update. Not sent in the body. */
