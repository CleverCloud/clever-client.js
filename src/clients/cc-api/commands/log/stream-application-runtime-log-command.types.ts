...
/**
 * Identifies the application whose runtime logs are streamed, and how to narrow the stream down. The owner is
...
export interface StreamApplicationRuntimeLogCommandInput extends ApplicationId {
   ...
   */
  limit?: number;
  /** Keep only the lines emitted by the instances of this deployment. */
  deploymentId?: string;
