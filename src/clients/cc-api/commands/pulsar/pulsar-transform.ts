...
export function transformPulsarInfo(payload: any): GetPulsarInfoInnerCommandOutput {
  return {
    ...
    plan: payload.plan,
    coldStorageId: payload.cold_storage_id ?? undefined,
...
export function transformPulsarCluster(payload: any): GetPulsarClusterInnerCommandOutput {
  return {
    ...
    pulsarTlsPort: payload.pulsar_tls_port ?? undefined,
    webPort: payload.web_port ?? undefined,
    webTlsPort: payload.web_tls_port ?? undefined,
