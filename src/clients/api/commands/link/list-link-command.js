 ...
 * @version 2
 */
export class ListApplicationToApplicationLinkCommand extends CcApiSimpleCommand {
 ...
 * @version 2
 */
export class ListApplicationToAddonLinkCommand extends CcApiSimpleCommand {
 ...
 * @version 2
 */
export class ListAddonToApplicationLinkCommand extends CcApiSimpleCommand {
