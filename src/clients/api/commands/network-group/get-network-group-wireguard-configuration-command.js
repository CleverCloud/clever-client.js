...
export class GetNetworkGroupWireguardConfigurationCommand extends CcApiSimpleCommand {
  ...
  toRequestParams(params) {
    return get(safeUrl`/v4/networkgroups/organisations/:XXX/networkgroups/:XXX/peers/:XXX/wireguard/configuration`);
  }

  /** @type {CcApiSimpleCommand<GetNetworkGroupWireguardConfigurationCommandInput, GetNetworkGroupWireguardConfigurationCommandOutput>['isEmptyResponse']} */
